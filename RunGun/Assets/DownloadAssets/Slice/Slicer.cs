...
namespace Slice {
    ...
    public sealed class Slicer {
        ...
        public static SlicedHull Slice(GameObject obj, Plane pl, TextureRegion crossRegion, Material crossMaterial)
        {
            ...
            SkinnedMeshRenderer skinedMeshRender = obj.GetComponent<SkinnedMeshRenderer>();
            ...
            else if (skinedMeshRender != null)
            {
                materials = skinedMeshRender.sharedMaterials;
            }
            else
            {
                Debug.LogWarning("EzySlice::Slice -> Provided GameObject must have a SkinnedMeshRenderer or MeshRenderer Component.");
                return null;
            }
